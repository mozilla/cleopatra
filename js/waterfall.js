...
Waterfall.prototype = {
  ...
  display: function Waterfall_display(data) {
    ...
    var typeOrder = ['RD', 'Scripts', 'Styles', 'Reflow', 'DisplayList', 'Rasterize', 'Composite', 'Vsync', 'SyncLayerTransaction', 'Other'];
    ...
    var colorList = ['rgba(0,200,0,0.5)', 'rgb(250,100,40)', 'rgb(40,40,100)', 'rgb(40,40,100)', 'rgb(150,40,100)', 'rgb(100,250,40)', 'rgb(100,40,250)', 'rgb(255, 128, 0', 'rgb(255, 128, 0)', 'rgb(200,0,0)'];
